...
class FootballDetailsPage extends StatefulWidget {
  ...
  const FootballDetailsPage({super.key, required this.onNext});

  @override
  State<FootballDetailsPage> createState() => _FootballDetailsPageState();
}
...
class _FootballDetailsPageState extends State<FootballDetailsPage> {
  ...
  void didChangeDependencies() {
    ...
    matchTypeKeys = {
      ...
      '4+1': loc.match_type_4plus1v4plus1,
      '5v5': loc.match_type_5v5,
      '5+1': loc.match_type_5plus1v5plus1,
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      await saveSportData('football', model);
      ...
      debugPrint('Error saving football details: $e');
      ScaffoldMessenger.of(context).showSnackBar(
