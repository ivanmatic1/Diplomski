...
class BasketballDetailsPage extends StatefulWidget {
  final VoidCallback onNext;

  const BasketballDetailsPage({super.key, required this.onNext});

  @override
  State<BasketballDetailsPage> createState() => _BasketballDetailsPageState();
}

class _BasketballDetailsPageState extends State<BasketballDetailsPage> {
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      debugPrint('Error saving basketball details: $e');
      ScaffoldMessenger.of(context).showSnackBar(
  ...
  Widget _glasslessContainer({required Widget child}) {
